...
@DataJpaTest
@Import({BookDao.class}) //из контекста достем этот класс
...
public class BookDaoTest {
    ...
    private final Book NEW_TEST_BOOK = new Book().setId(3L).setName("New horror book").setGenre(EXISTING_TEST_GENRE2);
    ...
    void getBookByNameTest() {
        ...
        assertThat(book.getGenre()).isEqualToComparingFieldByField(EXISTING_TEST_BOOK1.getGenre());
    }
    ...
    void insertNewBookTest() {
        ...
        assertThat(book.getGenre()).isEqualToComparingFieldByField(NEW_TEST_BOOK.getGenre());
    }
}
