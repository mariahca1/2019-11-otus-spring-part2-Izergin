...
public class BookDaoImpl {
    ...
    public Book getBookByName(String name) {
        ...
        Book b;
        try {
            b = jdbcTemplate.queryForObject("select * from books where name = :name", params, new BookMapper());
        } catch (EmptyResultDataAccessException e) {
            System.out.println("Книга с названием '" + name + "' не найдена!");
            b = null;
        }
        return b;
    }
    ...
    public int insertBook(Book book) {
        ...
        return (int) kh.getKeyList().get(0).get("id");
    }
